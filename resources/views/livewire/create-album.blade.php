    ...
    <div class="px-4 pt-6 pb-2 bg-white rounded-lg shadow-md md:pb-8 lg:px-8 dark:bg-midnight">
        <div>
            ...
            <div class="grid grid-cols-1 row-gap-6 col-gap-4 mt-6 sm:grid-cols-6">
                ...
                {{-- <div class="sm:col-span-2">
                    <label for="category" class="block text-sm font-medium leading-5 text-gray-700 dark:text-gray-100">
                        Category
                    </label>
                    <div class="mt-1 rounded-md shadow-sm">
                        <select wire:model="category" name="category" class="block w-full transition duration-150 ease-in-out form-select sm:text-sm sm:leading-5">
