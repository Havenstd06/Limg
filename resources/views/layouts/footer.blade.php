<footer class="text-gray-200 bg-gray-800 dark:bg-midnight dark:text-white font-firacode">
  <div class="flex flex-wrap items-center px-16 py-3">
    ...
    <div class="w-full mt-4 text-center lg:w-3/5 lg:mt-0">
      <span class="block mx-3 mb-4 font-semibold md:inline-block md:mb-0">
        Made with <i class="far fa-heart"></i> by <a href="https://github.com/havenstd06" target="_nofollow">Havens</a> — 2019-{{ date('Y') }}
      </span>
    </div>
