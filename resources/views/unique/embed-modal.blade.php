<div class="text-left">
  ...
  <textarea name="image" id="embed" cols="55" rows="4" class="p-1 bg-gray-100 border"><a href="{{ route('unique.show', ['unique' => $unique->shareName]) }}"><img src="{{ route('unique.show', ['unique' => $unique->shareName]) }}" alt="Limg" title="{{ $unique->title ? $unique->title . ' - Limg' : 'Limg' }}"></a></textarea>
