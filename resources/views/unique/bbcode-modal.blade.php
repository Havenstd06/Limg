<div class="text-left">
  ...
  <textarea name="image" id="bbcode" cols="55" rows="4" class="p-1 bg-gray-100 border">[url={{ route('unique.show', ['unique' => $unique->shareName]) }}][img]{{ route('unique.show', ['unique' => $unique->shareName]) }}[/img][/url]</textarea>
