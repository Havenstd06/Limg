...
<div class="flex items-center justify-center">
    <div class="bg-white shadow-md rounded md:w-1/4 px-8 mx-4 pt-6 pb-8 flex flex-col">
        <a href="{{ route('login.discord') }}">
            <div class="mx-4 mb-2">
                <button class="w-full text-white uppercase text-xs font-bold rounded bg-indigo-600 hover:bg-indigo-700 hover:text-white shadow-md py-2 px-5 flex items-center justify-center">
