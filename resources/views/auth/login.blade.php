            ...
            @csrf
                ...
                <div class="mb-4">
                    ...
                    @if ($errors->has('username') || $errors->has('email'))
                        <p class="text-xs italic text-red-600">{{ $errors->first('username') ?: $errors->first('email') }}</p>
                    @endif
                </div>
                <div class="mb-6">
                ...
                <div class="flex items-center justify-between">
                    ...
                    <a class="inline-block text-sm font-bold text-blue-700 align-baseline hover:text-blue-800" href="{{ route('password.request') }}">
                        {{ __('Forgot Password?') }}
                    </a>
                    @endif
                </div>
