    ...
    <div class="md:flex min-h-screen">
      <div class="w-full md:w-1/2 bg-white flex items-center justify-center ">
        <div class="max-w-sm m-8">
          ...
          <p class="text-grey-darker text-2xl md:text-3xl font-light mb-8 leading-normal">Our server encountered an internal error. <br>Sorry For The Inconvenience</p>
      ...
      <div class="relative pb-full md:flex md:pb-0 md:min-h-screen w-full md:w-1/2">
        <img src="{{ url('images/errors/500-illustration.svg') }}" alt="500" class="absolute pin bg-cover bg-no-repeat md:bg-right lg:bg-center">
        </div>
      </div>
    </div>
  </body>
