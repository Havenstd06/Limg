  ...
  <body class="antialiased font-sans">
    <div class="md:flex min-h-screen">
      <div class="w-full md:w-1/2 bg-white flex items-center justify-center ">
        ...
        <p class="text-grey-darker text-2xl md:text-3xl font-light mb-8 leading-normal">Sorry, you do not have access to this page.</p>
      ...
      <div class="relative pb-full md:flex md:pb-0 md:min-h-screen w-full md:w-1/2">
        <img src="{{ url('images/errors/403-illustration.svg') }}" alt="403" class="absolute pin bg-cover bg-no-repeat md:bg-right lg:bg-center">
        </div>
      </div>
    </div>
  </body>
